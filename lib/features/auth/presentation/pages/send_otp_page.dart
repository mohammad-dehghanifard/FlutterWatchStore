                        ...
                        BlocConsumer<AuthBloc, AuthState>(
                          ...
                          listener: (context, state) {
                            ...
                            if (state.authStatus is AuthSendSmsSuccess) {
                              final currentState =
                                  state.authStatus as AuthSendSmsSuccess;
                              _savePhone(phoneNumberTxt.text);
                              Navigator.pushNamed(
                                  context, WatchRoutes.checkOtpCode,
                                  arguments: {
                          ...
                          builder: (context, state) {
                            if (state.authStatus is AuthInitial ||
                                state.authStatus is AuthSendSmsSuccess) {
                              return Visibility(
                                visible: true,
...
_savePhone(String phone) async =>
    await di<SharedPreferences>().setString(StorageKey.userPhone, phone);
